...
(function(root) {
  "use strict";
  const catalog = [
    {id:"jelly",name:"젤리",english:"JELLY POP",description:"탱글탱글, 달콤한 컬러",tag:"반짝이는",swatch:"#16223a",palette:["#37bdd0","#eeb838","#a981e7","#67ba85","#ed8198","#699fe5","#eda25e"]},
    {id:"mochi",name:"모찌",english:"MOCHI FRIENDS",description:"볼이 발그레한 작은 친구들",tag:"귀여운",swatch:"#182540",palette:["#73c9cf","#e9c668","#ba9adb","#94c49a","#e998aa","#94b4e3","#eeb58b"]},
    {id:"crystal",name:"크리스탈",english:"CRYSTAL CLUB",description:"빛을 머금은 작은 보석",tag:"우아한",swatch:"#13253a",palette:["#44bace","#dcb547","#9a83d3","#5daf94","#dc7f9a","#659cda","#dd9c62"]},
    {id:"neon",name:"네온",english:"NEON STUDIO",description:"선명한 빛, 쿨한 존재감",tag:"멋있는",swatch:"#0e1628",palette:["#51e1ec","#ffe079","#c5a1ff","#8de3b1","#ff9caf","#95bbff","#ffbe87"]},
    {id:"retro",name:"레트로",english:"POCKET ARCADE",description:"손안의 작은 아케이드",tag:"경쾌한",swatch:"#1a2436",palette:["#32aaba","#dfac2f","#9979ca","#6fa771","#dc7481","#6e93c9","#d89050"]}
  ];
  ...
  function draw(ctx,x,y,size,value,id="jelly",ghost=false) {
    ...
    if(skin==="jelly") {
      ...
      const glaze=ctx.createLinearGradient(0,0,0,w);glaze.addColorStop(0,"#ffffff8a");glaze.addColorStop(.45,"#ffffff12");glaze.addColorStop(1,"#1c2a4826");
      ...
      rounded(ctx,0,size*.035,w,w-size*.035,size*.28,"#3a4a6624");
      ...
      ctx.strokeStyle="#4a5874";ctx.lineWidth=Math.max(.8,size*.032);ctx.lineCap="round";
      ...
      rounded(ctx,0,0,w,w,size*.2,"#1c2842");
      ...
      rounded(ctx,0,size*.055,w,w-size*.055,size*.09,"#3c4860");
      ...
      ctx.fillStyle="#2a36502e";ctx.fillRect(size*.2,w-size*.22,w-size*.3,size*.07);
      rounded(ctx,size*.25,size*.25,w-size*.5,w-size*.5,size*.045,"#ffffff18","#2d3a5526");
    }
    ctx.restore();
  }
